                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">PiCoin</h2>
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-aguadeluz">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Coconut</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-todo">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Nebula</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                        ...
                        <div className="w-more">
                          ...
                          A platform integrated with  switch, access point, and gateway makes it easy to manage network equipment. 
                          </span>
                        </div>
                      </div>
                      <div className="col-sm-4">
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-medlingos">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Url shortener</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
              ...
              <div className="work-box">
                <a href={stock} data-lightbox="gallery-smth">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Emegency Serv</h2>
                        <div className="w-more">
